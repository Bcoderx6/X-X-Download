...
"""
    START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('🗣️CREATOR', url='https://t.me/YashPutha'),
        InlineKeyboardButton('🤖GROUP', url='https://t.me/joinchat/ArkWZG_MBmBjMGM1'),
        ],[
...
URL | newfilename | username | password"""
    ...
    CUSTOM_CAPTION_UL_FILE = "<b>Join :-</b> @YashPutha"
